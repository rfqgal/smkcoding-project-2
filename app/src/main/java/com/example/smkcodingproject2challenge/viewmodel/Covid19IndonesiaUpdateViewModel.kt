...
class Covid19IndonesiaUpdateViewModel(): ViewModel() {
    ...
    fun updateData(indonesiaItem: Covid19IndonesiaItem) = viewModelScope.launch(Dispatchers.IO) {
        repository.update(indonesiaItem)
    }
}